...
(try_begin),
	...
	(call_script, "script_cf_agent_consume_items", ":agent_id", ":item1", ":item2", ":item3", ":item4"),
	(try_end),
(try_end),
	]),
...
(try_begin),
    (ge, reg4, 0),
	(val_add, ":bank", ":deposit"),
	(assign, reg76, ":bank"),
	(val_sub, ":banklimit", ":bank"),
	(assign, reg59, ":banklimit"),
    (assign, reg0, ":player_id"),
	(str_store_player_username, s56, ":player_id"),
    (player_get_unique_id, reg2, ":player_id"),
	...
	(str_store_string, s78, "@[!] Depositing {reg4} to bank, Current Balance {reg76}, You can still deposit {reg59} into your bank. "),
...
(try_begin),
	...
	(str_store_string, s78, "@[!] Withdrawing {reg4} from bank, Remaining Balance {reg53} "),
    (multiplayer_send_string_to_player, ":player_id", server_event_local_chat, s78),
(try_end),
]),
