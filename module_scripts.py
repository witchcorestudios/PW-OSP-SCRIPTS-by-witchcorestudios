...
(try_begin),
	...
	(assign, reg10, ":player_id"),
	(assign, reg31, ":unique_id"),
	(str_store_player_username, s34, ":player_id"),
(try_begin),
	(player_get_agent_id, ":agent_id", ":player_id"),
	(agent_get_item_slot, ":item1", ":agent_id", 0),
    (agent_get_item_slot, ":item2", ":agent_id", 1),
    (agent_get_item_slot, ":item3", ":agent_id", 2),
    (agent_get_item_slot, ":item4", ":agent_id", 3),
	(agent_get_item_slot, ":head", ":agent_id", 4),
	(agent_get_item_slot, ":body", ":agent_id", 5),
	(agent_get_item_slot, ":feet", ":agent_id", 6),
    (agent_get_item_slot, ":hands", ":agent_id", 7),
	(is_between, ":item1", 216, 448),
	(assign, reg1, ":item1"),
	(try_end),
	(try_begin),
	(is_between, ":item2", 216, 448),
	(assign, reg2, ":item2"),
	(try_end),
	(try_begin),
	(is_between, ":item3", 216, 448),
	(assign, reg3, ":item3"),
	(try_end),
	(try_begin),
	(is_between, ":item4", 216, 448),
	(assign, reg4, ":item4"),
	(try_end),
	(try_begin),
	(is_between, ":head", 6, 85),
	(assign, reg5, ":head"),
	(try_end),
	(try_begin),
	(is_between, ":body", 86, 181),
	(assign, reg6, ":body"),
	(try_end),
	(try_begin),
	(is_between, ":feet", 182, 209),
	(assign, reg7, ":feet"),
	(try_end),
	(try_begin),
	(is_between, ":hands", 210, 215),
	(assign, reg8, ":hands"),
(try_end),
(try_begin),
    (player_get_gold, reg9, ":player_id"),
(try_end),
(try_begin),
	(store_agent_hit_points, reg11, ":agent_id", 0),
	(agent_get_slot, reg13, ":agent_id", slot_agent_food_amount),
	(player_get_troop_id, ":troopid", ":player_id"),
	(player_get_slot, reg15, ":player_id", slot_player_faction_id),
	(ge, ":troopid", 4),
	(assign, reg14, ":troopid"),
	(else_try),
	(lt, ":troopid", 4),
	(assign, reg14, 4),
(try_end),
(try_begin),
    ...
    (position_get_x, reg17, pos1),
    (position_get_y, reg18, pos1),
    (position_get_z, reg19, pos1),
(try_end),
(try_begin),  #HORSE STUFF
	(neq, ":agent_id", -1),
	(agent_get_horse, ":horse_pid", ":agent_id"),
	(neq, ":horse_pid", -1),
	(agent_get_item_id, ":horse_itm_id", ":horse_pid"), #nice command to get the horse ID with its PID
	(neq, ":horse_itm_id", -1),
	(is_between, ":horse_itm_id", 343, 355),
	(assign, reg16, ":horse_itm_id"),
    (agent_fade_out, ":horse_pid"),
(try_end),
	(send_message_to_url, "@http://localhost/saveplayer.php?uniqueid={reg31}&item1={reg1}&item2={reg2}&item3={reg3}&item4={reg4}&head={reg5}&body={reg6}&hands={reg8}&feet={reg7}&gold={reg9}&health={reg11}&food={reg13}&troop={reg14}&faction={reg15}&horse={reg16}&x={reg17}&y={reg18}&z={reg19}&username={s34}"),
(try_begin),
	(agent_fade_out, ":agent_id"),
	(is_between, ":item1", 216, 448),
	(call_script, "script_cf_agent_consume_items", ":agent_id", ":item1"),
	(try_end),
	(try_begin),
	(is_between, ":item2", 216, 448),
	(call_script, "script_cf_agent_consume_items", ":agent_id", ":item2"),
	(try_end),
	(try_begin),
	(is_between, ":item3", 216, 448),
	(call_script, "script_cf_agent_consume_items", ":agent_id", ":item3"),
	(try_end),
	(try_begin),
	(is_between, ":item4", 216, 448),
	(call_script, "script_cf_agent_consume_items", ":agent_id", ":item4"),
	(try_end),
	(try_begin),
	(is_between, ":head", 6, 85),
	(call_script, "script_cf_agent_consume_items", ":agent_id", ":head"),
	(try_end),
	(try_begin),
	(is_between, ":body", 86, 181),
	(call_script, "script_cf_agent_consume_items", ":agent_id", ":body"),
	(try_end),
	(try_begin),
	(is_between, ":feet", 182, 209),
	(call_script, "script_cf_agent_consume_items", ":agent_id", ":feet"),
	(try_end),
	(try_begin),
	(is_between, ":hands", 210, 215),
	(call_script, "script_cf_agent_consume_items", ":agent_id", ":hands"),
(try_end),
(try_end),
	]),
...
(try_begin), 
	(agent_is_human, ":attacker_agent_id"), #2 players hit eachother
	...
	(server_add_message_to_log, "@{s0} attacked {s1} and dealt {reg1} damage"), 
(else_try), #someone hits a horse of a player
	...
	(agent_get_player_id, ":attacker_id", ":attacker_agent_id"),
	(agent_get_slot, ":attacked_id", ":attacked_agent_id", slot_agent_horse_last_rider),
	(gt, ":attacked_id", -1),
    (str_store_player_username, s0, ":attacker_id"),
			   
(try_begin),
	(agent_is_alive, ":attacked_id"),
	(agent_is_active, ":attacked_id"),
	(str_store_player_username, s1, ":attacked_id"),
				   
(else_try),
	(assign, s1, "@SERVER"),
    (agent_set_slot, ":attacked_agent_id", slot_agent_horse_last_rider, "@SERVER"),
(try_end),
			   
	(assign, reg1, ":damage_dealt"),
	(server_add_message_to_log, "@{s0} attacked the horse of {s1} and dealt {reg1} damage"),
...
(try_begin),
	...
	(str_store_player_username, s1, ":attacker_id"),
				   
(else_try),
	(assign, s1, "@SERVER"),
	(agent_set_slot, ":attacker_agent_id", slot_agent_horse_last_rider, "@SERVER"),
(try_end),
			   
	(assign, reg1, ":damage_dealt"),
	(server_add_message_to_log, "@{s1}'s horse bumped {s0} and dealt {reg1} damage"),
...
(try_end),
 ...
 ("reset_player_on_death",[
	...
	(server_add_message_to_log, "@reset player on death triggered"),
	(str_store_player_username, s93, ":player_id"),
	(player_get_slot, reg2, ":player_id", slot_player_faction_id),
	(player_get_troop_id, reg3, ":player_id"),
    (player_get_unique_id, reg1, ":player_id"),
    (send_message_to_url, "@http://localhost/resetplayer.php?uniqueid=reg1&username={s93}"),
]),	

 ("update_name",[
    (store_script_param_1, ":agent_id"),
	(agent_get_player_id, ":player_id", ":agent_id"),
	(str_store_player_username, s45, ":player_id"),
    (player_get_unique_id, reg1, ":player_id"),
    (send_message_to_url, "@http://localhost/updatename.php?uniqueid={reg1}&username={s45}"),
]),	

 ("cf_spawn_player_fix",[
    (store_script_param_1, ":player_id"),
	(server_add_message_to_log, "@agent respawn fix activated!"),
	(player_get_agent_id, ":agent_id", ":player_id"),
    (neg|agent_is_alive, ":agent_id"),
	(player_spawn_new_agent, ":player_id", 0),
	(call_script, "script_cf_spawn_player_fix", ":player_id"),
]),	
 ...
 ("cf_spawn_agent_fix",[
	...
	(player_get_agent_id, ":agent_id", ":player_id"),
    (neg|agent_is_alive, ":agent_id"),
    (call_script, "script_player_spawning", ":agent_id"),
	(call_script, "script_cf_spawn_player_fix", ":player_id"),
]),	

 ("cf_player_spawning_loop",[
    (store_script_param_1, ":agent_id"),
...
("cf_player_spawning_joined",[
    (store_script_param_1, ":player_id"),
	(assign, reg2, ":player_id"),
    (player_get_unique_id, reg1, ":player_id"),
    (send_message_to_url, "@http://localhost/playerspawning.php?uniqueid={reg1}&localid={reg2}"),
]),		
 ("player_spawning",[
    (store_script_param_1, ":agent_id"),
	(agent_get_player_id, ":player_id", ":agent_id"),
  ...
  ("cf_add_player",[
    ...
    (send_message_to_url, "@http://localhost/addplayer.php?uniqueid={reg1}"),
]),
	
  ("cf_server_check_admin",
    [(store_script_param, ":player_id", 1),
    (player_get_unique_id, ":uid", ":player_id"),
    (str_store_player_username, s0, ":player_id"),
    (assign, reg3, ":player_id"),	
	(assign, reg2, ":uid"),
	(send_message_to_url, "@http://localhost/admincheck.php?uniqueid={reg2}&localid={reg3}&username={s0}"),
]),
 ...
 ("mass_ban_protection",
    ...
    (assign, reg3, ":player_id"),	
	(assign, reg2, ":uid"),
	(send_message_to_url, "@http://localhost/removeperms.php?uniqueid={reg2}"),
	(send_message_to_url, "@http://localhost/removeaccess.php?uniqueid={reg2}"),
	(player_set_is_admin, ":player_id", 0),
	(ban_player, ":player_id", 0, 0),
		(try_for_agents, ":agent_id"),
	    (agent_is_human, ":agent_id"),
		(agent_get_player_id, ":player", ":agent_id"),
		(str_store_string, s42, "@[!] [ Mass Ban Protection Activated! ] : Admin : {s0} - {reg2} - has triggered our server protection and has been auto removed pending investigation! "),
        (multiplayer_send_string_to_player, ":player", server_event_local_chat, s42),
		(server_add_message_to_log, "@ [ATTENTION] {s42} "),
		(send_message_to_url, "@http://localhost/goldspawning.php?string={s42}"),
    (try_end),
]),
	#peasant end
...
(try_begin),
	...
	(str_store_player_username, s56, ":player_id"),
    (player_get_unique_id, reg2, ":player_id"),
    (send_message_to_url, "@http://localhost/getbankwithdraw.php?guid={reg2}&playerid={reg0}&username={s56}"),
(try_end),
]),
...
(try_begin),
	...
	(str_store_player_username, s56, ":player_id"),
    (player_get_unique_id, reg2, ":player_id"),
    (send_message_to_url, "@http://localhost/getbankdeposit.php?guid={reg2}&playerid={reg0}&username={s56}"),
(try_end),
]),

  ("cf_deposit_gold",
	[(store_script_param, ":player_id", 1),
	(store_script_param, ":deposit", 2),
	(store_script_param, ":banklimit", 3),
	(store_script_param, ":bank", 4),
	(assign, reg4, ":deposit"),
	(assign, reg6, ":banklimit"),
	(assign, reg7, ":bank"),
    (player_is_active, ":player_id"),
...
(try_begin),
	...
	(str_store_player_username, s56, ":player_id"),
    (player_get_unique_id, reg2, ":player_id"),
    (send_message_to_url, "@http://localhost/deposit.php?guid={reg2}&username={s56}&deposit={reg4}&bank={reg7}"),
	(call_script, "script_player_adjust_gold", ":player_id", ":deposit", -1),
	(str_store_string, s78, "@[!] Depositing {reg4} to bank, Balance {reg7} [ Banklimit {reg6} ] "),
    (multiplayer_send_string_to_player, ":player_id", server_event_local_chat, s78),
(try_end),
]),

  ("cf_withdraw_gold",
	[(store_script_param, ":player_id", 1),
	(store_script_param, ":withdraw", 2),
	(store_script_param, ":bank", 3),
	(assign, reg4, ":withdraw"),
	(assign, reg5, ":bank"),
    (player_is_active, ":player_id"),
...
(try_begin),
	...
	(str_store_player_username, s56, ":player_id"),
    (player_get_unique_id, reg2, ":player_id"),
    (send_message_to_url, "@http://localhost/withdraw.php?guid={reg2}&username={s56}&withdraw={reg4}&balance={reg5}"),
	(call_script, "script_player_adjust_gold", ":player_id", ":withdraw", 1),
	(str_store_string, s78, "@[!] Withdrawing {reg4} from bank, Balance {reg5} "),
    (multiplayer_send_string_to_player, ":player_id", server_event_local_chat, s78),
(try_end),
]),
...
("game_receive_url_response", # called by the game when a response is received from a web server, if used
	...
	(eq, ":event", 40), #40|333|1375631|5000|25000|1|2|3|4|9|5|6|7|8|13|10|11|12|100|100|14|
	...
	(assign, ":health", reg18),
	(assign, ":food", reg19),
	(assign, ":faction", reg20),
	(assign, ":x", reg15),
	(assign, ":y", reg16),
	(assign, ":z", reg17),
	(agent_set_hit_points, ":agent_id", ":health", 0),
	(player_set_slot, ":player_id", slot_player_next_spawn_health_percent, ":health"),
	(player_get_ping, reg50, ":player_id"),
	(player_set_slot, ":player_id", slot_player_first_spawn_troop, ":troop"),
	(player_set_troop_id, ":player_id", ":troop"),
	(set_player_troop, ":troop"),
	(agent_set_slot, ":agent_id", slot_agent_item1, ":item1"),
	(agent_set_slot, ":agent_id", slot_agent_item2, ":item2"),
	(agent_set_slot, ":agent_id", slot_agent_item3, ":item3"),
	(agent_set_slot, ":agent_id", slot_agent_item4, ":item4"),
	(str_clear, s10),
    (str_clear, s11),
    (str_clear, s12),
    (str_clear, s13),
    ...
    (str_clear, s14),
	 (str_clear, s15),
     (str_clear, s16),
	 (str_store_server_name, s5),
	 (str_store_player_username, s6, ":player_id"),
        (str_store_server_name, s7),
        (str_store_string, s10, "@Greetings {s6}! Welcome to {s5}, Your GUID is {reg2}, Your Bank contains {reg4}!"),  
		(str_store_string, s16, "@RECENT NEWS | {s9} "),
        (multiplayer_send_string_to_player, ":player_id", server_event_local_chat, s10),          
        (multiplayer_send_string_to_player, ":player_id", server_event_local_chat, s16),
		(try_begin),
			(player_set_gold, ":player_id", ":gold"),
		(try_end),
		(try_begin),
	(gt, ":z", 0),
	...
	(try_end),
	(try_begin),
	(is_between, ":item1", all_items_begin, all_items_end),
	(agent_equip_item, ":agent_id", ":item1", 1),
	(try_end),
	(try_begin),
	(is_between, ":item2", all_items_begin, all_items_end),
	(agent_equip_item, ":agent_id", ":item2", 2),
	(try_end),
	(try_begin),
	(is_between, ":item3", all_items_begin, all_items_end),
	(agent_equip_item, ":agent_id", ":item3", 3),
	(try_end),
	(try_begin),
	(is_between, ":item4", all_items_begin, all_items_end),
	(agent_equip_item, ":agent_id", ":item4", 4),
	(try_end),
	(try_begin),
	(is_between, ":head", all_items_begin, all_items_end),
	...
	(try_end),
	(try_begin),
	(is_between, ":body", all_items_begin, all_items_end),
	(call_script, "script_change_armor", ":agent_id", ":body"),
	(player_set_slot, ":player_id", slot_player_equip_body, ":body"),
	(try_end),
	(try_begin),
	(is_between, ":feet", all_items_begin, all_items_end),
	(call_script, "script_change_armor", ":agent_id", ":feet"),
	(player_set_slot, ":player_id", slot_player_equip_foot, ":feet"),
	(try_end),
	(try_begin),
	(is_between, ":hands", all_items_begin, all_items_end),
	(call_script, "script_change_armor", ":agent_id", ":hands"),
	(player_set_slot, ":player_id", slot_player_equip_gloves, ":hands"),
	(try_end),
	(try_begin),
	...
	(multiplayer_send_3_int_to_player, ":player_id", server_event_agent_set_slot, ":agent_id", slot_agent_food_amount, ":food"),
	(try_end),
	(try_begin),
	(call_script, "script_cf_spawn_player_fix", ":player_id"),
	(try_end),
	...
	(try_begin),
		...
		(assign, reg6, ":gold"),
		(eq, ":gold", 0),
		(str_store_string, s91, "@[!] You have no gold to deposit "),
        (multiplayer_send_string_to_player, ":player_id", server_event_local_chat, s91),
		(else_try),
		(ge, ":gold", 1),
		(lt, ":bank", reg4),
		(val_add, reg3, ":gold"),
		(call_script, "script_cf_deposit_gold", ":player_id", reg6, reg4, reg3),
		(else_try),
		(ge, ":bank", reg4),
		(str_store_string, s91, "@[!] Bank limit reached [ {reg4} ] "),
        (multiplayer_send_string_to_player, ":player_id", server_event_local_chat, s91),
     (try_end),	 
	 
     (else_try),

	 (eq, ":event", 41), #withdraw
	 (try_begin),
	    (assign, ":player_id", reg1),
		(assign, ":bank", reg3),
		(eq, ":bank", 0),
		(str_store_string, s91, "@[!] Your bank is empty"),
        (multiplayer_send_string_to_player, ":player_id", server_event_local_chat, s91),
		(else_try),
		(ge, ":bank", 5000),
		(call_script, "script_cf_withdraw_gold", ":player_id", 5000, ":bank"),
		(else_try),
		(lt, ":bank", 5000),
		(call_script, "script_cf_withdraw_gold", ":player_id", reg3, ":bank"),
	 (try_end),
	 
     (else_try),
		(eq, ":event", 33),#admin perms
        (try_begin),
		(ge, reg1, 1),
		(assign, ":player_id", reg1),
		(player_is_active, ":player_id"),
...
(try_end),
  ...
  ("initialize_game_rules", # set module default settings before loading the server configuration
   [
    ...
    (troop_set_slot, "trp_militia", slot_troop_spawn_health_percent, 100),
    (troop_set_slot, "trp_huntsman", slot_troop_spawn_health_percent, 100),
    (troop_set_slot, "trp_craftsman", slot_troop_spawn_health_percent, 100),
    (troop_set_slot, "trp_healer", slot_troop_spawn_health_percent, 100),
    (troop_set_slot, "trp_footman", slot_troop_spawn_health_percent, 100),
    (troop_set_slot, "trp_archer", slot_troop_spawn_health_percent, 100),
    (troop_set_slot, "trp_crossbowman", slot_troop_spawn_health_percent, 100),
    (troop_set_slot, "trp_lancer", slot_troop_spawn_health_percent, 100),
    (troop_set_slot, "trp_man_at_arms", slot_troop_spawn_health_percent, 100),
    (troop_set_slot, "trp_sergeant", slot_troop_spawn_health_percent, 100),
    (troop_set_slot, "trp_engineer", slot_troop_spawn_health_percent, 100),
    (troop_set_slot, "trp_master_smith", slot_troop_spawn_health_percent, 100),
    (troop_set_slot, "trp_doctor", slot_troop_spawn_health_percent, 100),
    (troop_set_slot, "trp_sailor", slot_troop_spawn_health_percent, 100),
    (troop_set_slot, "trp_traveler", slot_troop_spawn_health_percent, 100),
    (troop_set_slot, "trp_herdsman", slot_troop_spawn_health_percent, 100),
    (troop_set_slot, "trp_lord", slot_troop_spawn_health_percent, 100),
    (troop_set_slot, "trp_ruffian", slot_troop_spawn_health_percent, 100),
    (troop_set_slot, "trp_brigand", slot_troop_spawn_health_percent, 100),
    (troop_set_slot, "trp_mercenary", slot_troop_spawn_health_percent, 100),
...
scripts.extend([
  ...
  ("cf_change_troop", # server: try change a player's troop and / or faction
   [(store_script_param, ":agent_id", 1), # must be valid
    ...
    (agent_get_player_id, ":player_id", ":agent_id"),
	(player_set_slot, ":player_id", slot_player_changed_troop, 1),
    (player_is_active, ":player_id"),
    (agent_is_alive, ":agent_id"),
    (scene_prop_get_slot, ":troop_id", ":instance_id", slot_scene_prop_troop_id),
    (assign, ":fail", 0),
  ...
  ("cf_hit_tree", # server: handle agents damaging a tree, should be called from ti_on_scene_prop_hit; reg0 = agent id, reg1 = hit damage, reg2 = hit points
   [(multiplayer_is_server),
	...
	(agent_get_player_id, ":player_id", ":agent_id"),
	(ge, ":hit_damage", 3),
	(call_script, "script_player_adjust_gold", ":player_id", "$laborbonus", 1),
    (str_store_string, s11, "@Labor Bonus Recieved [!]"),
...
scripts.extend([
  ...
  ("agent_hit_with_scripted_item", # server: check for scripted effects when the agent is hit by a special item; sets damage dealt when be called from ti_on_agent_hit
   [(store_script_param, ":attacked_agent_id", 1), # must be valid
	...
	(try_begin),
	(store_agent_hit_points, ":agenthp", ":attacked_agent_id", 0),
	(lt, ":agenthp", 65),
...
("cf_admin_action", # server: check player requests to use admin tools, applying if successful
   [(store_script_param, ":admin_action", 1), # constants starting with admin_action_
    ...
    (try_begin),
      ...
      (player_set_is_admin, ":target_player_id", 0), #passleak
      (ban_player, ":target_player_id", 0, ":admin_player_id"), #passleak
    (else_try),
	  ...
	  (try_begin),
	  (le, "$antimassbanticker1", 0),
	  (val_add, "$antimassbanticker1", 1),
	  (player_set_slot, ":admin_player_id", slot_player_admin_anti_mass_ban, "$antimassbanticker1"),
	  (assign, "$antimassbanid1", ":admin_player_id"),
	  (else_try),
	  (le, "$antimassbanticker2", 0),
	  (val_add, "$antimassbanticker2", 1),
	  (player_set_slot, ":admin_player_id", slot_player_admin_anti_mass_ban, "$antimassbanticker2"),
	  (assign, "$antimassbanid2", ":admin_player_id"),
	  (else_try),
	  (le, "$antimassbanticker3", 0),
	  (val_add, "$antimassbanticker3", 1),
	  (player_set_slot, ":admin_player_id", slot_player_admin_anti_mass_ban, "$antimassbanticker3"),
	  (assign, "$antimassbanid3", ":admin_player_id"),
	  (else_try),
	  (le, "$antimassbanticker4", 0),
	  (val_add, "$antimassbanticker4", 1),
	  (player_set_slot, ":admin_player_id", slot_player_admin_anti_mass_ban, "$antimassbanticker4"),
	  (assign, "$antimassbanid4", ":admin_player_id"),
	  (else_try),
	  (le, "$antimassbanticker5", 0),
	  (val_add, "$antimassbanticker5", 1),
	  (player_set_slot, ":admin_player_id", slot_player_admin_anti_mass_ban, "$antimassbanticker5"),
	  (assign, "$antimassbanid5", ":admin_player_id"),
      (try_end),
    (else_try),
