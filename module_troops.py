...
####################################################################################################################
  ...
  ["archer","Archer","an archer",tf_guarantee_all,0,0,"fac_commoners",
   ...
   str_14|agi_14|pw_attr,wpex(100,80,80,200,70,70),knows_pw|knows_ironflesh_4|knows_power_strike_3|knows_power_draw_6|knows_athletics_6|knows_riding_2|knows_sailing_3,default_face_1,default_face_2],
